...
typedef void (^SRSelectHandle)(NSInteger index, NSString *content);
...
@property (nonatomic, strong) NSArray *caroArr;

@property (nonatomic, copy) SRSelectHandle block;
 ...
 */
- (void)sr_showAtPoint:(CGPoint)point
